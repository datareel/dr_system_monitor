...
if [ -f ${CONFIGdir}/${fname} ]; then 
    	echo "INFO - Config file exists ${CONFIGdir}/${fname}"
	echo "INFO - Will not overwrite existing PHP config"
	fname="drsm.php_install_new"
fi
cat /dev/null > ${CONFIGdir}/${fname}
echo '<?php ' >> ${CONFIGdir}/${fname}
echo '// DRSM PHP config ' >> ${CONFIGdir}/${fname}
echo '// Auto generated by DRSM install script ' >> ${CONFIGdir}/${fname}
echo -n '$WWWdir = ' >> ${CONFIGdir}/${fname}; echo "'${WWWdir}';" >> ${CONFIGdir}/${fname}
echo -n '$WWWvpath = ' >> ${CONFIGdir}/${fname}; echo "'${WWWvpath}';" >> ${CONFIGdir}/${fname}
echo -n '$REPORTdir = ' >> ${CONFIGdir}/${fname}; echo "'${REPORTdir}';" >> ${CONFIGdir}/${fname}
echo -n '$REPORTvpath = ' >> ${CONFIGdir}/${fname}; echo "'${REPORTvpath}';" >> ${CONFIGdir}/${fname}
echo -n '$REPORTarchive = ' >> ${CONFIGdir}/${fname}; echo "'${REPORTarchive}';" >> ${CONFIGdir}/${fname}
echo -n '$REPORTarchivevpath = ' >> ${CONFIGdir}/${fname}; echo "'${REPORTarchivevpath}';" >> ${CONFIGdir}/${fname}
echo -n '$CONFIGdir = ' >> ${CONFIGdir}/${fname}; echo "'${CONFIGdir}';" >> ${CONFIGdir}/${fname}
echo -n '$SITEincludes = ' >> ${CONFIGdir}/${fname}; echo "'${SITEincludes}';" >> ${CONFIGdir}/${fname}
echo '?>' >> ${CONFIGdir}/${fname}
chmod 664 ${CONFIGdir}/${fname}
chown ${SYSADMIN_USERNAME}:${SYSADMIN_GROUPNAME} ${CONFIGdir}/${fname}
